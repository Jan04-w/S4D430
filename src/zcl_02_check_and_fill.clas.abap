CLASS zcl_02_check_and_fill DEFINITION PUBLIC
 FINAL
 CREATE PUBLIC.
...
CLASS ZCL_02_CHECK_AND_FILL IMPLEMENTATION.
...
*
    CONSTANTS z02employ  TYPE tabname VALUE 'Z02EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'Z02DEPMENT'.

    TRY.
        NEW lcl_generator( i_version       = c_version
                           i_employ_table  = z02employ
